...
str1='countryname is my country'
print('str1 : ',str1)
str2=input('Enter your country name : ')
str3=str1.replace('countryname', str2)
...
str4='the red car is nice and the car looks like bmw car'
print('str4 : ',str4)
list2=str4.split()
